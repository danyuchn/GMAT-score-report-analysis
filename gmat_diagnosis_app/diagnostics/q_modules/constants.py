...
PARAM_ASSIGNMENT_RULES = {
    ...
    # Fast & Wrong (不再區分 REAL/PURE)
    ('Fast & Wrong', 'REAL'): ['Q_READING_COMPREHENSION_ERROR', 'Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR', 'Q_FOUNDATIONAL_MASTERY_INSTABILITY_SFE', 'BEHAVIOR_EARLY_RUSHING_FLAG_RISK', 'BEHAVIOR_CARELESSNESS_ISSUE'],
    ('Fast & Wrong', 'PURE'): ['Q_READING_COMPREHENSION_ERROR', 'Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR', 'Q_FOUNDATIONAL_MASTERY_INSTABILITY_SFE', 'BEHAVIOR_EARLY_RUSHING_FLAG_RISK', 'BEHAVIOR_CARELESSNESS_ISSUE'],
    # Slow & Wrong (不再區分 REAL/PURE)
    ('Slow & Wrong', 'REAL'): ['Q_READING_COMPREHENSION_ERROR', 'Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR', 'Q_FOUNDATIONAL_MASTERY_INSTABILITY_SFE', 'Q_READING_COMPREHENSION_DIFFICULTY', 'Q_CONCEPT_APPLICATION_DIFFICULTY', 'Q_CALCULATION_DIFFICULTY'],
    ('Slow & Wrong', 'PURE'): ['Q_READING_COMPREHENSION_ERROR', 'Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR', 'Q_FOUNDATIONAL_MASTERY_INSTABILITY_SFE', 'Q_READING_COMPREHENSION_DIFFICULTY', 'Q_CONCEPT_APPLICATION_DIFFICULTY', 'Q_CALCULATION_DIFFICULTY'],
    # Normal Time & Wrong (不再區分 REAL/PURE)
    ('Normal Time & Wrong', 'REAL'): ['Q_READING_COMPREHENSION_ERROR', 'Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR', 'Q_FOUNDATIONAL_MASTERY_INSTABILITY_SFE', 'BEHAVIOR_EARLY_RUSHING_FLAG_RISK', 'BEHAVIOR_CARELESSNESS_ISSUE'],
    ('Normal Time & Wrong', 'PURE'): ['Q_READING_COMPREHENSION_ERROR', 'Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR', 'Q_FOUNDATIONAL_MASTERY_INSTABILITY_SFE', 'BEHAVIOR_EARLY_RUSHING_FLAG_RISK', 'BEHAVIOR_CARELESSNESS_ISSUE'],
    # Slow & Correct (不再區分 REAL/PURE)
    ('Slow & Correct', 'REAL'): ['Q_READING_COMPREHENSION_DIFFICULTY', 'Q_CONCEPT_APPLICATION_DIFFICULTY', 'Q_CALCULATION_DIFFICULTY'],
    ('Slow & Correct', 'PURE'): ['Q_READING_COMPREHENSION_DIFFICULTY', 'Q_CONCEPT_APPLICATION_DIFFICULTY', 'Q_CALCULATION_DIFFICULTY'],
    ...
    ('Unknown', 'PURE'): ['Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR', 'Q_READING_COMPREHENSION_ERROR'],
    ('Unknown', None): ['Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR', 'Q_READING_COMPREHENSION_ERROR'], # Fallback
}

# Default params if incorrect but category/type combo not found above
DEFAULT_INCORRECT_PARAMS = ['Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR', 'Q_READING_COMPREHENSION_ERROR']
