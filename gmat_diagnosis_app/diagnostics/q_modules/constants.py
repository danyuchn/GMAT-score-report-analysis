...
PARAM_ASSIGNMENT_RULES = {
    ...
    ('Slow & Wrong', 'Real'): ['Q_READING_COMPREHENSION_ERROR', 'Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR'],
    ('Slow & Wrong', 'Pure'): ['Q_CONCEPT_APPLICATION_ERROR', 'Q_CALCULATION_ERROR'],
