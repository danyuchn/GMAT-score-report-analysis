...
APPENDIX_A_TRANSLATION_V = {
    ...
    'CR_REASONING_ERROR_LOGIC_CHAIN_ANALYSIS_PREMISE_CONCLUSION_RELATIONSHIP': "CR 推理錯誤: 邏輯鏈分析 (前提與結論關係)",
    'CR_REASONING_ERROR_ABSTRACT_LOGIC_TERMINOLOGY_UNDERSTANDING': "CR 推理錯誤: 抽象邏輯/術語理解",
    'CR_REASONING_ERROR_PREDICTION_DIRECTION': "CR 推理錯誤: 預判方向",
    'CR_REASONING_ERROR_CORE_ISSUE_IDENTIFICATION': "CR 推理錯誤: 核心議題識別",
    'CR_CHOICE_UNDERSTANDING_ERROR_VOCAB': "CR 選項理解錯誤: 選項詞彙",
    'CR_CHOICE_UNDERSTANDING_ERROR_SYNTAX': "CR 選項理解錯誤: 選項句式",
    'CR_CHOICE_UNDERSTANDING_ERROR_LOGIC': "CR 選項理解錯誤: 選項邏輯",
    ...
    'CR_REASONING_DIFFICULTY_PREDICTION_DIRECTION_MISSING': "CR 推理障礙: 預判方向",
    'CR_REASONING_DIFFICULTY_CORE_ISSUE_IDENTIFICATION': "CR 推理障礙: 核心議題識別",
    'CR_REASONING_DIFFICULTY_CHOICE_RELEVANCE_JUDGEMENT': "CR 推理障礙: 選項相關性判斷",
    'CR_REASONING_DIFFICULTY_STRONG_DISTRACTOR_CHOICE_ANALYSIS': "CR 推理障礙: 強干擾選項辨析",
    'CR_CHOICE_UNDERSTANDING_DIFFICULTY_VOCAB': "CR 選項理解障礙: 選項詞彙理解",
    'CR_CHOICE_UNDERSTANDING_DIFFICULTY_SYNTAX': "CR 選項理解障礙: 選項句式理解",
    'CR_CHOICE_UNDERSTANDING_DIFFICULTY_LOGIC': "CR 選項理解障礙: 選項邏輯理解",
    'CR_CHOICE_UNDERSTANDING_DIFFICULTY_DOMAIN': "CR 選項理解障礙: 選項領域理解",
    'CR_STEM_UNDERSTANDING_DIFFICULTY_MINDSET_BLOCKED': "CR 題幹理解障礙：心態失常讀不進去",

    'RC_READING_COMPREHENSION_ERROR_VOCAB': "RC 閱讀理解錯誤: 詞彙理解",
    'RC_READING_COMPREHENSION_ERROR_LONG_DIFFICULT_SENTENCE_ANALYSIS': "RC 閱讀理解錯誤: 長難句解析",
    'RC_READING_COMPREHENSION_ERROR_PASSAGE_STRUCTURE': "RC 閱讀理解錯誤: 篇章結構理解",
    'RC_READING_COMPREHENSION_ERROR_KEY_INFO_LOCATION_UNDERSTANDING': "RC 閱讀理解錯誤: 關鍵信息定位/理解",
    'RC_QUESTION_UNDERSTANDING_ERROR_FOCUS_POINT': "RC 題目理解錯誤: 提問焦點理解",
    'RC_LOCATION_SKILL_ERROR_LOCATION': "RC 定位能力錯誤: 定到錯誤位置",
    'RC_REASONING_ERROR_INFERENCE': "RC 推理錯誤: 預想推理不符",
    'RC_CHOICE_ANALYSIS_ERROR_VOCAB': "RC 選項辨析錯誤: 選項詞彙理解",
    'RC_CHOICE_ANALYSIS_ERROR_SYNTAX': "RC 選項辨析錯誤: 選項句式理解",
    'RC_CHOICE_ANALYSIS_ERROR_LOGIC': "RC 選項辨析錯誤: 選項邏輯理解",
    'RC_CHOICE_ANALYSIS_ERROR_DOMAIN': "RC 選項辨析錯誤: 選項領域理解",
    'RC_CHOICE_ANALYSIS_ERROR_RELEVANCE_JUDGEMENT': "RC 選項辨析錯誤: 選項相關性判斷",
    ...
    'RC_READING_COMPREHENSION_DIFFICULTY_MINDSET_BLOCKED': "RC 閱讀理解障礙: 心態失常讀不進去",
    'RC_QUESTION_UNDERSTANDING_DIFFICULTY_FOCUS_POINT_GRASP': "RC 題目理解障礙: 提問焦點把握困難",
    'RC_QUESTION_UNDERSTANDING_DIFFICULTY_MINDSET_BLOCKED': "RC 題目理解障礙: 心態失常讀不進去",
    'RC_LOCATION_SKILL_DIFFICULTY_INEFFICIENCY': "RC 定位能力障礙: 找尋不到定位",
    'RC_REASONING_DIFFICULTY_INFERENCE_SPEED_SLOW': "RC 推理障礙: 預想推理緩慢",
